...
/*   Updated: 2026/03/01 15:01:22 by aternero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	testDeepCopy()
{
	...
	Cat	thirstCat(firstCat);
	std::cout << "Cat C idea[0]: " << thirstCat.getBrain()->getIdea(0) << std::endl;
	...
	Dog	thirstDog(firstDog);
	std::cout << "Dog C idea[1]: " << thirstDog.getBrain()->getIdea(1) << std::endl;
